...
export class UsersService {
  ...
  /**
   * Returns the ObjectId string of the platform company (isPlatformCompany: true).
   * Used to route the email verification notification through the platform's own
