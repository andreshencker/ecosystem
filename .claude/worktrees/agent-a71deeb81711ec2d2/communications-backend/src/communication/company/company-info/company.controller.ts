...
export class CompanyController {
  ...
  async reprovision(
    ...
    // Determine whether this is the platform company so the correct provisioning
    // path runs: platform gets theme+layouts+domain+events; tenant gets theme+layouts only.
