...
date: 2026-06-23
status: accepted
tags: [adr, architecture, backend, communication, platform, multi-tenant]
---
...
interface CommunicationContext {
  ownerCompanyId: ObjectId;         // platform company or tenant company _id
...
| `InvitationService` — company user invitation | Company | Company managing its own team |
