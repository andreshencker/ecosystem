...
import { CompanyDeletionService }
  from './company-deletion.service';

import { CompanyTheme, CompanyThemeSchema }
  from '../company-theme/schemas/company-theme.schema';
import { CompanyIntegration, CompanyIntegrationSchema }
  from '../integrations/schemas/company-integration.schema';

import { CompanyChannelProvider, CompanyChannelProviderSchema }
  from '../../channels/company-channel-providers/schemas/company-channel-provider.schema';
import { ProviderCredentials, ProviderCredentialsSchema }
  from '../../channels/provider-credentials/schemas/provider-credentials.schema';

import { LayoutTemplate, LayoutTemplateSchema }
...
import { NotificationExecutionLog, NotificationExecutionLogSchema }
  from '../../notifications/execution-log/schemas/execution-log.schema';

import { CompanySmtp, CompanySmtpSchema }
  from '../../../platform/company/schemas/company-smtp.schema';
import { Invitation, InvitationSchema }
  from '../../../platform/user-invitations/schemas/invitation.schema';
import { User, UserSchema }
  from '../../../platform/users/schemas/user.schema';
import { RefreshToken, RefreshTokenSchema }
  from '../../../platform/auth/schemas/refresh-token.schema';

import { MediaModule }
  from '../../files/media/media.module';
import { UsersModule }
  from '../../../platform/users/users.module';
import { UserInvitationsModule }
  from '../../../platform/user-invitations/user-invitations.module';
import { NotificationModule }
  from '../../notifications/notification.module';
import { CompanyProvisioningModule }
  from '../provisioning/company-provisioning.module';
...
@Module({
  imports: [
    MongooseModule.forFeature([
      ...
      { name: NotificationExecutionLog.name, schema: NotificationExecutionLogSchema },
      // Platform resources
