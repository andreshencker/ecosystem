 ...
 * flow (owner/provider/internal), not by app. 'owner' and 'provider' share
...
export class RoleCatalogEntry {
  @Prop({ required: true, enum: ['owner', 'provider', 'internal'], index: true })
  flow!: 'owner' | 'provider' | 'internal';
