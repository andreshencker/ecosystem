...
export default function AcceptInvitationPage() {
  ...
  return <main className="invitation-page"><section><BrandMark/><span className="section-kicker">Grapifly invitation</span>{state === 'accepting' && <><h1>Joining your organization…</h1><p>Grapifly is verifying your identity and invitation.</p></>}{state === 'accepted' && <><h1>You’re in.</h1><p>Your organization membership is now active.</p><a href="/organizations">View organizations</a></>}{state === 'signin' && <><h1>Sign in first.</h1><p>Use the Google account matching the invited email. Grapifly will return you to this invitation automatically.</p><a href={`${apiUrl}/auth/google/invitation/${encodeURIComponent(token)}`}>Continue with Google</a></>}{state === 'error' && <><h1>Invitation unavailable.</h1><p>The link may have expired, been used or belong to another account.</p><a href="/home">Return to Grapifly</a></>}</section></main>;
}
