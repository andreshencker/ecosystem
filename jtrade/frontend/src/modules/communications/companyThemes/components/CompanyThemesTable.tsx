...
type Props = {
    rows?: CompanyTheme[];
    loading?: boolean;
    onView?: (row: CompanyTheme) => void;
    onEdit?: (row: CompanyTheme) => void;
    onDelete?: (row: CompanyTheme) => void;
};

export default function CompanyThemesTable({
                                               rows = [],
                                               loading,
                                               onView,
                                               onEdit,
    ...
    const renderActions = (row: CompanyTheme) => (
        <Stack
            direction="row"
            spacing={1}
            alignItems="center"
        ...
        >
            ...
            <DeleteConfirmButton
                ...
                confirmText={`Are you sure you want to delete "${row.label}"?`}
        ...
        >
            ...
            >
                ...
                >
                    <TableHead>
                        <TableRow>
                            <TableCell sx={{ minWidth: 260 }}>Theme name</TableCell>
