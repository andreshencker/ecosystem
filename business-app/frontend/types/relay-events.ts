...
export interface RelayEventListResponse {
  data: RelayEvent[];
  total: number;
  limit: number;
  offset: number;
...
export const EVENT_TYPE_OPTIONS: { value: RelayEventType; label: string }[] = [
...
export function getDomainDisplayName(domainCatalogueId: RelayEvent['domainCatalogueId']): string {
