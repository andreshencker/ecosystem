...
export function PurposeFormDrawer({
  ...
  return (
    <FormDrawer
      open={open}
      onClose={onClose}
      title={isEdit ? `Edit — ${purpose?.displayName}` : 'New Communication Purpose'}
      actions={
        <>
        ...
        <Box>
          ...
          <Box display="flex" flexDirection="column" gap={2}>
            ...
            <CredentialSelect
              ...
              emptyMessage="No active email credentials available in Communications"
            ...
            <CredentialSelect
              ...
              options={smsOptions}
              loading={loadingSms}
              emptyMessage="No active SMS credentials available in Communications"
