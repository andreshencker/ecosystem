...
} from '@/hooks/api/useCommunicationPurposes';
...
export default function CommunicationPurposesPage() {
  const router = useRouter();

  // ── Connection pre-check ──────────────────────────────────────────────────
  // Reuse the existing integration hook (GET /settings/communications).
  ...
  // While we check if Communications is connected, show a minimal skeleton
  ...
  // Communications integration is not configured (or is disabled).
    ...
    return (
      <Box>
        <PageHeader
          ...
          subtitle="Manage notification domains (purposes) in Communications."
        />
        <EmptyState
          icon={CableOutlinedIcon}
          title="Communications not connected"
          description={
            'This feature requires a Communications connection before you can create or manage Communication Purposes.\n' +
            'Connect your Business App to Communications first.'
          }
          action={
            <Button
              variant="contained"
  ...
  return (
    <Box>
      ...
      <ConfirmDialog
        open={!!confirmDelete}
        title="Delete Communication Purpose?"
        description={
          confirmDelete
