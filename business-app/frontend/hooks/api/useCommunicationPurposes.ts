...
const BASE = '/settings/communication-purposes';
...
export function usePurposes({ enabled = true, ...params }: PurposesParams = {}) {
  return useQuery({
    queryKey: ['communication-purposes', params],
    queryFn: () =>
      apiClient
...
export function usePurpose(id: string, options?: { enabled?: boolean }) {
  return useQuery({
    queryKey: ['communication-purposes', id],
    queryFn: () =>
...
export function useCredentialOptions(
  ...
  return useQuery({
    queryKey: ['communication-purposes', 'credential-options', channel],
    queryFn: () =>
      apiClient
...
export function useCreatePurposeMutation() {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['communication-purposes'] });
...
export function useUpdatePurposeMutation() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, { id }) => {
      qc.invalidateQueries({ queryKey: ['communication-purposes'] });
      qc.invalidateQueries({ queryKey: ['communication-purposes', id] });
...
export function useDeletePurposeMutation() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, id) => {
      qc.invalidateQueries({ queryKey: ['communication-purposes'] });
      qc.removeQueries({ queryKey: ['communication-purposes', id] });
