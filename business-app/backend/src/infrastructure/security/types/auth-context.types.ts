 ...
 *   { sub, role, scope, companyId, businessKey, type }
 */
export interface AuthContext {
  ...
  /** Email of the authenticated user. Populated by GlobalAuthGuard DB lookup. */
  email?: string;
  ...
  /** Denormalised business slug (businessKey from Business). */
   ...
   * JWT payload shape (role + scope + companyId + businessKey).
   */
