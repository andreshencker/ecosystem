import type { DocumentDomainSeed } from '../../../catalog/document-catalog.types';
...
const field = (
  ...
  required = false,
  format = '',
) => ({ key, label, type, required, format });

export const SHIFT_INVOICE_DOCUMENT_DOMAIN: DocumentDomainSeed = {
  domainKey: 'invoice',
