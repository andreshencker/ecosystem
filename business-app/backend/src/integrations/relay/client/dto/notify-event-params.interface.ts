 ...
 * Business events → that Business's own RelayConnection.
 *
 * Relay App never receives the `type` field.
 * Credential resolution is entirely internal to RelayClientService.
 */
 ...
 * Uses the identified Business's own RelayConnection.
