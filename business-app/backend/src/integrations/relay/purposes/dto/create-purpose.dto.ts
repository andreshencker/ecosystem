...
export class ChannelToUseInputDto {
  ...
  @ApiProperty({ description: 'ProviderCredentials ObjectId from Relay' })
  @IsMongoId()
...
export class CreatePurposeDto {
  @ApiProperty({
    example: 'invoicing',
    description:
      'Unique key for this purpose (lowercase, immutable after creation)',
  })
  @IsString()
  @MinLength(1)
  @MaxLength(100)
  ...
  @ApiProperty({
    example: 'billing',
    description: 'Category grouping (e.g. billing, support, marketing)',
  })
  @IsString()
  @MinLength(1)
  @MaxLength(100)
