...
exports.LoggingModule = LoggingModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [logger_service_1.LoggerService, request_id_middleware_1.RequestIdMiddleware],
        exports: [logger_service_1.LoggerService, request_id_middleware_1.RequestIdMiddleware],
    })
], LoggingModule);
