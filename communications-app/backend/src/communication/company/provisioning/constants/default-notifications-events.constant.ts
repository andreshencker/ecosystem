...
export const DEFAULT_NOTIFICATIONS_EVENTS: DefaultNotificationsEventDefinition[] =
  [
...

    {
      ...
      description:
        'Notify the company owner when a new integration token is created for an external application.',
      eventType: 'notification',
      scope: 'platform',
      senderScope: 'platform',
      channelContent: {
...
<p style="margin: 0 0 16px; color: {{theme.mutedTextColor}}; font-size: 13px;">
  If you did not authorise this action, contact your administrator immediately.
...

    {
      ...
      description:
        'Notify the company owner when an integration token is rotated. The previous token is immediately invalidated.',
      eventType: 'notification',
      scope: 'platform',
      senderScope: 'platform',
      channelContent: {
...
<p style="margin: 0 0 16px; color: {{theme.mutedTextColor}}; font-size: 13px;">
  If you did not authorise this rotation, contact your administrator immediately.
...

    {
      ...
      description:
        'Notify the company owner when an integration token is permanently revoked or deleted.',
      eventType: 'notification',
      scope: 'platform',
      senderScope: 'platform',
      channelContent: {
...
<p style="margin: 0 0 16px; color: {{theme.mutedTextColor}}; font-size: 13px;">
  External systems using this token no longer have access. A new integration must be created if connectivity is required.
...

    {
      ...
      description:
        'Notify the company owner when a new provider credential is added to a channel.',
      eventType: 'notification',
      scope: 'platform',
      senderScope: 'platform',
      channelContent: {
        email: {
          enabled: true,
          subject:
            'New credential added — {{data.providerName}} ({{data.channel}})',
...
<p style="margin: 0 0 16px; color: {{theme.mutedTextColor}}; font-size: 13px;">
  If you did not authorise this change, contact your platform administrator immediately.
...

    {
      ...
      description:
        'Notify the company owner when a provider credential is modified.',
      eventType: 'notification',
      scope: 'platform',
      senderScope: 'platform',
      channelContent: {
        email: {
          enabled: true,
          subject:
            'Credential updated — {{data.providerName}} ({{data.channel}})',
...
<table style="border-collapse: collapse; margin: 16px 0;">
  ...
  <tr><td style="padding: 4px 16px 4px 0; color: {{theme.mutedTextColor}};">Updated at</td><td style="padding: 4px 0;">{{data.updatedAt}}</td></tr>
...

    {
      ...
      description:
        'Notify the company owner when a provider credential is re-activated.',
      eventType: 'notification',
      scope: 'platform',
      senderScope: 'platform',
      channelContent: {
        email: {
          enabled: true,
          subject:
            'Credential activated — {{data.providerName}} ({{data.channel}})',
...
<table style="border-collapse: collapse; margin: 16px 0;">
  ...
  <tr><td style="padding: 4px 16px 4px 0; color: {{theme.mutedTextColor}};">Activated at</td><td style="padding: 4px 0;">{{data.activatedAt}}</td></tr>
...

    {
      ...
      description:
        'Notify the company owner when a provider credential is deactivated.',
      eventType: 'notification',
      scope: 'platform',
      senderScope: 'platform',
      channelContent: {
        email: {
          enabled: true,
          subject:
            'Credential deactivated — {{data.providerName}} ({{data.channel}})',
...
<table style="border-collapse: collapse; margin: 16px 0;">
  ...
  <tr><td style="padding: 4px 16px 4px 0; color: {{theme.mutedTextColor}};">Deactivated at</td><td style="padding: 4px 0;">{{data.deactivatedAt}}</td></tr>
...

    {
      ...
      description:
        'Notify the company owner when a provider credential is permanently deleted.',
      eventType: 'notification',
      scope: 'platform',
      senderScope: 'platform',
      channelContent: {
        email: {
          enabled: true,
          subject:
            'Credential deleted — {{data.providerName}} ({{data.channel}})',
...
<table style="border-collapse: collapse; margin: 16px 0;">
  ...
  <tr><td style="padding: 4px 16px 4px 0; color: {{theme.mutedTextColor}};">Deleted at</td><td style="padding: 4px 0;">{{data.deletedAt}}</td></tr>
...

    {
      ...
      description:
        'Notify the company owner when a credential connection test passes successfully.',
      eventType: 'notification',
      scope: 'platform',
      senderScope: 'platform',
      channelContent: {
        email: {
          enabled: true,
          subject:
            'Credential verified ✓ — {{data.providerName}} ({{data.channel}})',
...
<table style="border-collapse: collapse; margin: 16px 0;">
  ...
  <tr><td style="padding: 4px 16px 4px 0; color: {{theme.mutedTextColor}};">Verified at</td><td style="padding: 4px 0;">{{data.verifiedAt}}</td></tr>
...

    {
      ...
      description:
        'Notify the company owner when an integration token reaches its configured expiry date and is no longer valid.',
      eventType: 'notification',
      scope: 'platform',
      senderScope: 'platform',
      channelContent: {
