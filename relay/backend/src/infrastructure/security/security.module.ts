...
@Module({
  imports: [
    ...
    // Required so GlobalAuthGuard can validate x-integration-token headers by
    // asking Grapifly (CommunicationTokenValidatorService). No circular
    // dependency: EcosystemModule does not import SecurityModule.
    EcosystemModule,
  ],
  providers: [
    JwtStrategy,
